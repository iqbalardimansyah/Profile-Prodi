        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <a href="{{ route('admin.partner_researches.add') }}" class="btn btn-primary waves-effect waves-light ml-3 mt-3 mb-4">
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $partner)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.partner_researches.delete', encode($partner->id)) }}" method="POST" class="d-flex">
                                                @csrf
                                                @method("DELETE")
                                                ...
                                                <a href="{{ route('admin.partner_researches.edit', encode($partner->id)) }}" class="btn btn-warning btn-sm">
